...
return [
    ...
    'confirmed' => 'Potwierdzenie pola :attribute nie pasuje do siebie.',
    ...
    'doesnt_start_with' => 'Pole :attribute nie może rozpoczynać się od jednej z następujących wartości: :values.',
    ...
    'gt' => [
        ...
        'file' => 'Pole :attribute musi być większy niż :value kilobajtów.',
    ...
    'gte' => [
        ...
        'file' => 'Pole :attribute musi być większy lub równy :value kilobajtów.',
        'numeric' => 'Pole :attribute musi być większe lub równe :value.',
        'string' => 'Pole :attribute musi być dłuższe lub równe :value znaków.',
    ],
    'hex_color' => 'Pole :attribute musi mieć prawidłowy szesnastkowy kolor.',
    ...
    'mac_address' => 'Pole :attribute musi mieć prawidłowy adres MAC.',
    'max' => [
    ...
    'prohibited_unless' => 'Pole :attribute jest zabronione, chyba że :other występuje w :values.',
    ...
    'ulid' => 'Pole :attribute musi być prawidłowym ULID-em.',
    'uuid' => 'Pole :attribute musi być prawidłowym UUID-em.',
    ...
    'attributes' => [
        'email' => 'adres e-mail',
        'privacy_consent' => 'zgoda na politykę prywatności',
        'marketing_consent' => 'zgoda marketingowa',
        'code' => 'kod',
        'website' => 'pole zabezpieczające',
        'render_ts' => 'znacznik czasowy formularza',
        'cf-turnstile-response' => 'weryfikacja Turnstile',
        'answers' => 'odpowiedzi',
    ],
